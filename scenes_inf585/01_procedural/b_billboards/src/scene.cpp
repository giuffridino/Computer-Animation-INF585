...
void scene_structure::display_billboard()
{
	...
	for (int k = 0; k < N; ++k)
	{
		...
		particle_billboard& par_billboard = particle_system.billboards[k];
		vec3 const p = par_billboard.evaluate_position(timer_billboard.t);
		// if (k == 0)
		// {
